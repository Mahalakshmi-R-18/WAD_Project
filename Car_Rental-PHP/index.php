                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-5 col-md-offset-1">
                            <h1 class="brand-heading" style="color: black">Your Journey, Our Wheels</h1>
                            <p class="intro-text">
                                Online Car Rental 
                            </p>
...
<br>
        <section class="menu-content">
            ...
            <h6> Price: <br>With AC - <?php echo ("Rs. " . $ac_price . "/km & Rs." . $ac_price_per_day . "/day"); ?></h6>
            <h6>        Without AC - <?php echo ("Rs. " . $non_ac_price . "/km & Rs." . $non_ac_price_per_day . "/day"); ?></h6>
