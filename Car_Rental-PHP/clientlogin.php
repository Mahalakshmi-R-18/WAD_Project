...
?>
    ...
    <head>
        <title> Admin Login | Wheels On The Way </title>
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="background-color: #42D548; color:#ffffff">
        ...
        <div class="container">
            <div class="jumbotron">
                <h1 class="text-center"> Admin Login | Wheels On The Way </span>
                </h1>
                <br>
                ...
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="" method="POST">
                                ...
                                <div class="form-group col-xs-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <label class="btn btn-success"><span class="glyphicon glyphicon-user" aria-hidden="true"></label>
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-xs-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <label class="btn btn-success"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></label>
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <center><label style="margin-left: 5px;"><a href="clientsignup.php">Create a new account..SignUp Here</a></label></center>
                        </form>
                    </div>
                </div>
            </div>
